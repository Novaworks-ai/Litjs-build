...
`;var Wt=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,N=(o,t,e,r)=>{for(var s=r>1?void 0:r?Bt(t,e):t,i=o.length-1,n;i>=0;i--)(n=o[i])&&(s=(r?n(t,e,s):n(s))||s);return r&&s&&Wt(t,e,s),s};let lt=0;f.AccordionWidget=class extends O{constructor(){super(...arguments),this.title="Title",this.collapsed=!1,this.contentId=`accordion-content-${++lt}`,this.buttonId=`accordion-button-${lt}`}toggle(){this.collapsed=!this.collapsed}render(){return it`
      <div class="accordion">
        <button
          id=${this.buttonId}
          class="header"
    ...
    `}},f.AccordionWidget.styles=[Dt,Ht,jt,Nt,Rt,It,Lt,u`
      :host {
        display: block;
      }
    ...
    `],N([V({type:String})],f.AccordionWidget.prototype,"title",2),N([V({type:String})],f.AccordionWidget.prototype,"icon",2),N([Mt()],f.AccordionWidget.prototype,"collapsed",2),f.AccordionWidget=N([Ot("accordion-widget")],f.AccordionWidget),Object.defineProperty(f,Symbol.toStringTag,{value:"Module"})}));
