 ...
 */var ve;const T=globalThis,St=T.ShadowRoot&&(T.ShadyCSS===void 0||T.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ot=Symbol(),Jt=new WeakMap;let Kt=class{constructor(t,r,a){if(this._$cssResult$=!0,a!==Ot)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(St&&t===void 0){const a=r!==void 0&&r.length===1;a&&(t=Jt.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&Jt.set(r,t))}return t}toString(){return this.cssText}};const Xt=e=>new Kt(typeof e=="string"?e:e+"",void 0,Ot),f=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((a,o,i)=>a+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+e[i+1],e[0]);return new Kt(r,e,Ot)},ye=(e,t)=>{if(St)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const a=document.createElement("style"),o=T.litNonce;o!==void 0&&a.setAttribute("nonce",o),a.textContent=r.cssText,e.appendChild(a)}},Gt=St?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const a of t.cssRules)r+=a.cssText;return Xt(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:xe,defineProperty:$e,getOwnPropertyDescriptor:ke,getOwnPropertyNames:_e,getOwnPropertySymbols:Ce,getPrototypeOf:Ae}=Object,M=globalThis,Zt=M.trustedTypes,Se=Zt?Zt.emptyScript:"",zt=M.reactiveElementPolyfillSupport,Q=(e,t)=>e,ut={toAttribute(e,t){switch(t){case Boolean:e=e?Se:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},Dt=(e,t)=>!xe(e,t),Qt={attribute:!0,type:String,converter:ut,reflect:!1,useDefault:!1,hasChanged:Dt};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),M.litPropertyMetadata??(M.litPropertyMetadata=new WeakMap);let Y=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=Qt){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(t,r),!r.noAccessor){const a=Symbol(),o=this.getPropertyDescriptor(t,a,r);o!==void 0&&$e(this.prototype,t,o)}}static getPropertyDescriptor(t,r,a){const{get:o,set:i}=ke(this.prototype,t)??{get(){return this[r]},set(s){this[r]=s}};return{get:o,set(s){const l=o==null?void 0:o.call(this);i==null||i.call(this,s),this.requestUpdate(t,l,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Qt}static _$Ei(){if(this.hasOwnProperty(Q("elementProperties")))return;const t=Ae(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Q("properties"))){const r=this.properties,a=[..._e(r),...Ce(r)];for(const o of a)this.createProperty(o,r[o])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[a,o]of r)this.elementProperties.set(a,o)}this._$Eh=new Map;for(const[r,a]of this.elementProperties){const o=this._$Eu(r,a);o!==void 0&&this._$Eh.set(o,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const a=new Set(t.flat(1/0).reverse());for(const o of a)r.unshift(Gt(o))}else t!==void 0&&r.push(Gt(t));return r}static _$Eu(t,r){const a=r.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(r=>r(this))}addController(t){var r;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((r=t.hostConnected)==null||r.call(t))}removeController(t){var r;(r=this._$EO)==null||r.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const a of r.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ye(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(r=>{var a;return(a=r.hostConnected)==null?void 0:a.call(r)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(r=>{var a;return(a=r.hostDisconnected)==null?void 0:a.call(r)})}attributeChangedCallback(t,r,a){this._$AK(t,a)}_$ET(t,r){var i;const a=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,a);if(o!==void 0&&a.reflect===!0){const s=(((i=a.converter)==null?void 0:i.toAttribute)!==void 0?a.converter:ut).toAttribute(r,a.type);this._$Em=t,s==null?this.removeAttribute(o):this.setAttribute(o,s),this._$Em=null}}_$AK(t,r){var i,s;const a=this.constructor,o=a._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const l=a.getPropertyOptions(o),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((i=l.converter)==null?void 0:i.fromAttribute)!==void 0?l.converter:ut;this._$Em=o;const h=n.fromAttribute(r,l.type);this[o]=h??((s=this._$Ej)==null?void 0:s.get(o))??h,this._$Em=null}}requestUpdate(t,r,a){var o;if(t!==void 0){const i=this.constructor,s=this[t];if(a??(a=i.getPropertyOptions(t)),!((a.hasChanged??Dt)(s,r)||a.useDefault&&a.reflect&&s===((o=this._$Ej)==null?void 0:o.get(t))&&!this.hasAttribute(i._$Eu(t,a))))return;this.C(t,r,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,r,{useDefault:a,reflect:o,wrapped:i},s){a&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,s??r??this[t]),i!==!0||s!==void 0)||(this._$AL.has(t)||(this.hasUpdated||a||(r=void 0),this._$AL.set(t,r)),o===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var a;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[i,s]of o){const{wrapped:l}=s,n=this[i];l!==!0||this._$AL.has(i)||n===void 0||this.C(i,void 0,s,n)}}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(a=this._$EO)==null||a.forEach(o=>{var i;return(i=o.hostUpdate)==null?void 0:i.call(o)}),this.update(r)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(r)}willUpdate(t){}_$AE(t){var r;(r=this._$EO)==null||r.forEach(a=>{var o;return(o=a.hostUpdated)==null?void 0:o.call(a)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(r=>this._$ET(r,this[r]))),this._$EM()}updated(t){}firstUpdated(t){}};Y.elementStyles=[],Y.shadowRootOptions={mode:"open"},Y[Q("elementProperties")]=new Map,Y[Q("finalized")]=new Map,zt==null||zt({ReactiveElement:Y}),(M.reactiveElementVersions??(M.reactiveElementVersions=[])).push("2.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
\f\r]`,ot=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,oe=/-->/g,ae=/>/g,I=RegExp(`>|${Et}(?:([^\\s"'>=/]+)(${Et}*=${Et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ie=/'/g,se=/"/g,ne=/^(?:script|style|textarea|title)$/i,De=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),c=De(1),_=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),le=new WeakMap,R=U.createTreeWalker(U,129);function ce(e,t){if(!Pt(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return te!==void 0?te.createHTML(t):t}const Pe=(e,t)=>{const r=e.length-1,a=[];let o,i=t===2?"<svg>":t===3?"<math>":"",s=ot;for(let l=0;l<r;l++){const n=e[l];let h,m,p=-1,g=0;for(;g<n.length&&(s.lastIndex=g,m=s.exec(n),m!==null);)g=s.lastIndex,s===ot?m[1]==="!--"?s=oe:m[1]!==void 0?s=ae:m[2]!==void 0?(ne.test(m[2])&&(o=RegExp("</"+m[2],"g")),s=I):m[3]!==void 0&&(s=I):s===I?m[0]===">"?(s=o??ot,p=-1):m[1]===void 0?p=-2:(p=s.lastIndex-m[2].length,h=m[1],s=m[3]===void 0?I:m[3]==='"'?se:ie):s===se||s===ie?s=I:s===oe||s===ae?s=ot:(s=I,o=void 0);const u=s===I&&e[l+1].startsWith("/>")?" ":"";i+=s===ot?n+Oe:p>=0?(a.push(h),n.slice(0,p)+ee+n.slice(p)+N+u):n+N+(p===-2?l:u)}return[ce(e,i+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class at{constructor({strings:t,_$litType$:r},a){let o;this.parts=[];let i=0,s=0;const l=t.length-1,n=this.parts,[h,m]=Pe(t,r);if(this.el=at.createElement(h,a),R.currentNode=this.el.content,r===2||r===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(o=R.nextNode())!==null&&n.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(const p of o.getAttributeNames())if(p.endsWith(ee)){const g=m[s++],u=o.getAttribute(p).split(N),w=/([.?@])?(.*)/.exec(g);n.push({type:1,index:i,name:w[2],strings:u,ctor:w[1]==="."?Te:w[1]==="?"?Me:w[1]==="@"?Ne:ft}),o.removeAttribute(p)}else p.startsWith(N)&&(n.push({type:6,index:i}),o.removeAttribute(p));if(ne.test(o.tagName)){const p=o.textContent.split(N),g=p.length-1;if(g>0){o.textContent=gt?gt.emptyScript:"";for(let u=0;u<g;u++)o.append(p[u],et()),R.nextNode(),n.push({type:2,index:++i});o.append(p[g],et())}}}else if(o.nodeType===8)if(o.data===re)n.push({type:2,index:i});else{let p=-1;for(;(p=o.data.indexOf(N,p+1))!==-1;)n.push({type:7,index:i}),p+=N.length-1}i++}}static createElement(t,r){const a=U.createElement("template");return a.innerHTML=t,a}}function V(e,t,r=e,a){var s,l;if(t===_)return t;let o=a!==void 0?(s=r._$Co)==null?void 0:s[a]:r._$Cl;const i=rt(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==i&&((l=o==null?void 0:o._$AO)==null||l.call(o,!1),i===void 0?o=void 0:(o=new i(e),o._$AT(e,r,a)),a!==void 0?(r._$Co??(r._$Co=[]))[a]=o:r._$Cl=o),o!==void 0&&(t=V(e,o._$AS(e,t.values),o,a)),t}let Ee=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:a}=this._$AD,o=((t==null?void 0:t.creationScope)??U).importNode(r,!0);R.currentNode=o;let i=R.nextNode(),s=0,l=0,n=a[0];for(;n!==void 0;){if(s===n.index){let h;n.type===2?h=new J(i,i.nextSibling,this,t):n.type===1?h=new n.ctor(i,n.name,n.strings,this,t):n.type===6&&(h=new je(i,this,t)),this._$AV.push(h),n=a[++l]}s!==(n==null?void 0:n.index)&&(i=R.nextNode(),s++)}return R.currentNode=U,o}p(t){let r=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,r),r+=a.strings.length-2):a._$AI(t[r])),r++}};class J{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,r,a,o){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=a,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=V(this,t,r),rt(t)?t===v||t==null||t===""?(this._$AH!==v&&this._$AR(),this._$AH=v):t!==this._$AH&&t!==_&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ze(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==v&&rt(this._$AH)?this._$AA.nextSibling.data=t:this.T(U.createTextNode(t)),this._$AH=t}$(t){var i;const{values:r,_$litType$:a}=t,o=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=at.createElement(ce(a.h,a.h[0]),this.options)),a);if(((i=this._$AH)==null?void 0:i._$AD)===o)this._$AH.p(r);else{const s=new Ee(o,this),l=s.u(this.options);s.p(r),this.T(l),this._$AH=s}}_$AC(t){let r=le.get(t.strings);return r===void 0&&le.set(t.strings,r=new at(t)),r}k(t){Pt(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let a,o=0;for(const i of t)o===r.length?r.push(a=new J(this.O(et()),this.O(et()),this,this.options)):a=r[o],a._$AI(i),o++;o<r.length&&(this._$AR(a&&a._$AB.nextSibling,o),r.length=o)}_$AR(t=this._$AA.nextSibling,r){var a;for((a=this._$AP)==null?void 0:a.call(this,!1,!0,r);t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var r;this._$AM===void 0&&(this._$Cv=t,(r=this._$AP)==null||r.call(this,t))}}class ft{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,a,o,i){this.type=1,this._$AH=v,this._$AN=void 0,this.element=t,this.name=r,this._$AM=o,this.options=i,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=v}_$AI(t,r=this,a,o){const i=this.strings;let s=!1;if(i===void 0)t=V(this,t,r,0),s=!rt(t)||t!==this._$AH&&t!==_,s&&(this._$AH=t);else{const l=t;let n,h;for(t=i[0],n=0;n<i.length-1;n++)h=V(this,l[a+n],r,n),h===_&&(h=this._$AH[n]),s||(s=!rt(h)||h!==this._$AH[n]),h===v?t=v:t!==v&&(t+=(h??"")+i[n+1]),this._$AH[n]=h}s&&!o&&this.j(t)}j(t){t===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Te extends ft{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===v?void 0:t}}class Me extends ft{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==v)}}class Ne extends ft{constructor(t,r,a,o,i){super(t,r,a,o,i),this.type=5}_$AI(t,r=this){if((t=V(this,t,r,0)??v)===_)return;const a=this._$AH,o=t===v&&a!==v||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,i=t!==v&&(a===v||o);o&&this.element.removeEventListener(this.name,this,a),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,t):this._$AH.handleEvent(t)}}class je{constructor(t,r,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){V(this,t)}}const Le={I:J},Tt=tt.litHtmlPolyfillSupport;Tt==null||Tt(at,J),(tt.litHtmlVersions??(tt.litHtmlVersions=[])).push("3.3.1");const Ue=(e,t,r)=>{const a=(r==null?void 0:r.renderBefore)??t;let o=a._$litPart$;if(o===void 0){const i=(r==null?void 0:r.renderBefore)??null;a._$litPart$=o=new J(t.insertBefore(et(),i),i,void 0,r??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const H=globalThis;let b=class extends Y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var r;const t=super.createRenderRoot();return(r=this.renderOptions).renderBefore??(r.renderBefore=t.firstChild),t}update(t){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ue(r,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return _}};b._$litElement$=!0,b.finalized=!0,(ve=H.litElementHydrateSupport)==null||ve.call(H,{LitElement:b});const Mt=H.litElementPolyfillSupport;Mt==null||Mt({LitElement:b}),(H.litElementVersions??(H.litElementVersions=[])).push("4.2.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ie={attribute:!0,type:String,converter:ut,reflect:!1,hasChanged:Dt},Re=(e=Ie,t,r)=>{const{kind:a,metadata:o}=r;let i=globalThis.litPropertyMetadata.get(o);if(i===void 0&&globalThis.litPropertyMetadata.set(o,i=new Map),a==="setter"&&((e=Object.create(e)).wrapped=!0),i.set(r.name,e),a==="accessor"){const{name:s}=r;return{set(l){const n=t.get.call(this);t.set.call(this,l),this.requestUpdate(s,n,e)},init(l){return l!==void 0&&this.C(s,void 0,e,l),l}}}if(a==="setter"){const{name:s}=r;return function(l){const n=this[s];t.call(this,l),this.requestUpdate(s,n,e)}}throw Error("Unsupported decorator location: "+a)};function d(e){return(t,r)=>typeof r=="object"?Re(e,t,r):((a,o,i)=>{const s=o.hasOwnProperty(i);return o.constructor.createProperty(i,a),s?Object.getOwnPropertyDescriptor(o,i):void 0})(e,t,r)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const Nt=mt(class extends vt{constructor(e){var t;if(super(e),e.type!==bt.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var a,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!((a=this.nt)!=null&&a.has(i))&&this.st.add(i);return this.render(t)}const r=e.element.classList;for(const i of this.st)i in t||(r.remove(i),this.st.delete(i));for(const i in t){const s=!!t[i];s===this.st.has(i)||(o=this.nt)!=null&&o.has(i)||(s?(r.add(i),this.st.add(i)):(r.remove(i),this.st.delete(i)))}return _}});var He=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,K=(e,t,r,a)=>{for(var o=a>1?void 0:a?Be(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&He(t,r,o),o};let B=class extends b{constructor(){super(...arguments),this.tabs=[],this.showTabsCount=3,this.variant="primary",this.selectedTab="",this.moreOpen=!1,this.outsideClickHandler=e=>{const t=typeof e.composedPath=="function"?e.composedPath():this.fallbackPath(e.target);Array.isArray(t)&&!t.includes(this)&&(this.moreOpen=!1)},this.onKeyDownTablist=e=>{if(!["ArrowLeft","ArrowRight","Home","End"].includes(e.key))return;const r=Array.from(this.renderRoot.querySelectorAll('[role="tab"]')).filter(s=>!s.closest('[data-more="true"]')||this.moreOpen);if(!r.length)return;const a=document.activeElement,o=r.indexOf(a),i=s=>{const l=r[s];l==null||l.focus(),l==null||l.click()};switch(e.preventDefault(),e.key){case"ArrowRight":i((o+1+r.length)%r.length);break;case"ArrowLeft":i((o-1+r.length)%r.length);break;case"Home":i(0);break;case"End":i(r.length-1);break}}}createRenderRoot(){return this}fallbackPath(e){const t=[];let r=e;for(;r;)t.push(r),r=r.parentNode;return t}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.outsideClickHandler)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this.outsideClickHandler)}firstUpdated(){this.tabs.length>0&&(this.selectedTab=this.tabs[0].value)}selectTab(e){this.selectedTab=e.value,this.moreOpen=!1,this.dispatchEvent(new CustomEvent("tab-change",{detail:{value:e.value},bubbles:!0,composed:!0}))}toggleMore(e){e.stopPropagation(),this.moreOpen=!this.moreOpen}getVariantClasses(){switch(this.variant){case"primary":return"text-primary hover:text-primary-800 border-primary";case"secondary":return"text-gray-600 hover:text-gray-800 border-gray-300";case"success":return"text-green-600 hover:text-green-700 border-green-400";case"danger":return"text-red-600 hover:text-red-700 border-red-400";default:return"text-hover:text-primary border-indigo-500"}}render(){const e=this.tabs.slice(0,this.showTabsCount),t=this.tabs.slice(this.showTabsCount),r=this.getVariantClasses();return c`
      ...
      >
        <!-- Visible Tabs -->
        ${e.map(a=>{const o=this.selectedTab===a.value,i="px-12 py-8 border-b-2 transition-all text-sm",s=`font-semibold border-current ${r}`,n=`${i} ${o?s:"font-normal text-gray-600 hover:text-primary-900 border-transparent"}`;return c`
            <button
              role="tab"
              aria-selected=${String(o)}
              tabindex=${o?"0":"-1"}
              aria-controls=${`${a.value}-panel`}
              class=${n}
              ...
              <div class="relative" data-more="true">
                ...
                ${this.moreOpen?c`
                      <div
                        ...
                        role="listbox"
                      >
                        ${t.map(a=>{const o=this.selectedTab===a.value,i=Nt({"w-full text-left py-8 px-12 text-sm hover:bg-gray-100 transition":!0,"font-semibold text-primary":o,"font-normal text-gray-700":!o});return c`
                            <button
                              role="tab"
                              aria-selected=${String(o)}
                              tabindex=${o?"0":"-1"}
    ...
    `}handleClick(e){(this.disabled||this.loading)&&(e.preventDefault(),e.stopPropagation())}handleHover(){!this.disabled&&!this.loading&&this.dispatchEvent(new CustomEvent("hover",{bubbles:!0}))}handleLeave(){this.dispatchEvent(new CustomEvent("leave",{bubbles:!0}))}};C.styles=f`
    ${Xt(qe)}
 ...
 */let Lt=class extends jt{};Lt.directiveName="unsafeSVG",Lt.resultType=2;const pr=mt(Lt),k=(e,t="")=>{if(!e||!e.icon)return c``;const r=e.icon[0],a=e.icon[1],o=e.icon[4],i=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${r} ${a}" fill="currentColor" aria-hidden="true"><path d="${o}"/></svg>`;return c`<span class="${t} inline-block">${pr(i)}</span>`};var dr=Object.defineProperty,hr=Object.getOwnPropertyDescriptor,wt=(e,t,r,a)=>{for(var o=a>1?void 0:a?hr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&dr(t,r,o),o};let it=class extends b{constructor(){super(...arguments),this.employeeId="",this.employee={fullName:"John Doe",title:"Senior Frontend Engineer",location:"New York, USA",avatarUrl:"https://i.pravatar.cc/150?img=12"}}createRenderRoot(){return this}updated(e){e.has("employeeId")&&this._loadEmployee(this.employeeId)}async _loadEmployee(e){}_handleOrgChartClick(){this.onOrgChartClick&&this.onOrgChartClick(this.employeeId,this.employee),this.dispatchEvent(new CustomEvent("org-chart-click",{detail:{employeeId:this.employeeId,employee:this.employee},bubbles:!0}))}_onTabChange(e){this.dispatchEvent(new CustomEvent("section-change",{detail:e.detail,bubbles:!0,composed:!0}))}render(){const e=this.employee;return c`
    ...
    `}};wt([d({type:String})],it.prototype,"employeeId",2),wt([x()],it.prototype,"employee",2),wt([d({type:Function})],it.prototype,"onOrgChartClick",2),it=wt([y("profile-header")],it);const A=f`
  :host {
    font-size: 16px;
...
`;var mr=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,yt=(e,t,r,a)=>{for(var o=a>1?void 0:a?vr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&mr(t,r,o),o};let he=0,G=class extends b{constructor(){super(...arguments),this.title="Title",this.collapsed=!1,this.contentId=`accordion-content-${++he}`,this.buttonId=`accordion-button-${he}`}toggle(){this.collapsed=!this.collapsed}render(){return c`
      <div class="accordion">
        <button
          id=${this.buttonId}
          class="header"
    ...
    `],yt([d({type:String})],G.prototype,"title",2),yt([d({type:String})],G.prototype,"icon",2),yt([x()],G.prototype,"collapsed",2),G=yt([y("accordion-widget")],G);var wr=Object.defineProperty,yr=Object.getOwnPropertyDescriptor,Ut=(e,t,r,a)=>{for(var o=a>1?void 0:a?yr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&wr(t,r,o),o};let st=class extends b{constructor(){super(...arguments),this.title="",this.icon=""}render(){return c`
    ...
    `}};st.styles=[D,A,O,S,L,z,X,f`
      :host {
        font-size: 16px;
        display: block;
      }

    `],Ut([d({type:String})],st.prototype,"title",2),Ut([d({type:String})],st.prototype,"icon",2),st=Ut([y("card-widget")],st);var xr=Object.defineProperty,$r=Object.getOwnPropertyDescriptor,It=(e,t,r,a)=>{for(var o=a>1?void 0:a?$r(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&xr(t,r,o),o};let nt=class extends b{constructor(){super(...arguments),this.label="About"}render(){const e=!!(this.text&&this.text.trim());return c`
      <div role="region" aria-label=${this.label}>
        <h2 class="sr-only">${this.label}</h2>
        ${e?c`<p class="text">${this.text}</p>`:c`<slot></slot>`}
      </div>
    `}};nt.styles=[D,A,O,S,L,z,X,f`
      :host {
        font-size: 16px;
        display: block;
      }
    ...
    `],It([d({type:String,attribute:"text"})],nt.prototype,"text",2),It([d({type:String})],nt.prototype,"label",2),nt=It([y("about-widget")],nt);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:kr}=Le,ue=()=>document.createComment(""),lt=(e,t,r)=>{var i;const a=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(r===void 0){const s=a.insertBefore(ue(),o),l=a.insertBefore(ue(),o);r=new kr(s,l,e,e.options)}else{const s=r._$AB.nextSibling,l=r._$AM,n=l!==e;if(n){let h;(i=r._$AQ)==null||i.call(r,e),r._$AM=e,r._$AP!==void 0&&(h=e._$AU)!==l._$AU&&r._$AP(h)}if(s!==o||n){let h=r._$AA;for(;h!==s;){const m=h.nextSibling;a.insertBefore(h,o),h=m}}}return r},q=(e,t,r=e)=>(e._$AI(t,r),e),_r={},Cr=(e,t=_r)=>e._$AH=t,Ar=e=>e._$AH,Rt=e=>{e._$AR(),e._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ge=(e,t,r)=>{const a=new Map;for(let o=t;o<=r;o++)a.set(e[o],o);return a},xt=mt(class extends vt{constructor(e){if(super(e),e.type!==bt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let a;r===void 0?r=t:t!==void 0&&(a=t);const o=[],i=[];let s=0;for(const l of e)o[s]=a?a(l,s):s,i[s]=r(l,s),s++;return{values:i,keys:o}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,a]){const o=Ar(e),{values:i,keys:s}=this.dt(t,r,a);if(!Array.isArray(o))return this.ut=s,i;const l=this.ut??(this.ut=[]),n=[];let h,m,p=0,g=o.length-1,u=0,w=i.length-1;for(;p<=g&&u<=w;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(l[p]===s[u])n[u]=q(o[p],i[u]),p++,u++;else if(l[g]===s[w])n[w]=q(o[g],i[w]),g--,w--;else if(l[p]===s[w])n[w]=q(o[p],i[w]),lt(e,n[w+1],o[p]),p++,w--;else if(l[g]===s[u])n[u]=q(o[g],i[u]),lt(e,o[p],o[g]),g--,u++;else if(h===void 0&&(h=ge(s,u,w),m=ge(l,p,g)),h.has(l[p]))if(h.has(l[g])){const E=m.get(s[u]),Vt=E!==void 0?o[E]:null;if(Vt===null){const we=lt(e,o[p]);q(we,i[u]),n[u]=we}else n[u]=q(Vt,i[u]),lt(e,o[p],Vt),o[E]=null;u++}else Rt(o[g]),g--;else Rt(o[p]),p++;for(;u<=w;){const E=lt(e,n[w+1]);q(E,i[u]),n[u++]=E}for(;p<=g;){const E=o[p++];E!==null&&Rt(E)}return this.ut=s,Cr(e,n),_}});var Sr=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,Ht=(e,t,r,a)=>{for(var o=a>1?void 0:a?Or(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Sr(t,r,o),o};let ct=class extends b{constructor(){super(...arguments),this.skillsData=null,this.sections=[]}updated(e){e.has("skillsData")&&this.transformSkillsData()}transformSkillsData(){var r,a;if(!this.skillsData){this.sections=[];return}if(Array.isArray(this.skillsData)){this.sections=this.skillsData;return}const e=this.skillsData,t=[];(r=e.required_skills)!=null&&r.length&&t.push({sectionTitle:"Required Skills",skills:e.required_skills}),(a=e.additional_skills)!=null&&a.length&&t.push({sectionTitle:"Additional Skills",skills:e.additional_skills}),this.sections=t}getSections(){return this.sections}setSkillsData(e){this.skillsData=e}renderSection(e,t){return c`
    ...
    `:c`<p class="empty-state" role="status">No skills available.</p>`}};ct.styles=[D,A,O,S,L,z,gr,f`
      :host {
        font-size: 16px;
        display: block;
        color: var(--color-text, #111827);
    ...
    `],Ht([d({attribute:!1})],ct.prototype,"skillsData",2),Ht([x()],ct.prototype,"sections",2),ct=Ht([y("employee-skills-widget")],ct);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe="important",zr=" !"+fe,Dr=mt(class extends vt{constructor(e){var t;if(super(e),e.type!==bt.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,r)=>{const a=e[r];return a==null?t:t+`${r=r.includes("-")?r:r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const a of this.ft)t[a]==null&&(this.ft.delete(a),a.includes("-")?r.removeProperty(a):r[a]=null);for(const a in t){const o=t[a];if(o!=null){this.ft.add(a);const i=typeof o=="string"&&o.endsWith(zr);a.includes("-")||i?r.setProperty(a,i?o.slice(0,-11):o,i?fe:""):r[a]=o}}return _}});var Pr=Object.defineProperty,Er=Object.getOwnPropertyDescriptor,Bt=(e,t,r,a)=>{for(var o=a>1?void 0:a?Er(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Pr(t,r,o),o};let pt=class extends b{constructor(){super(...arguments),this.fields=[],this.columns=2}getIconTemplate(e){return e.iconTemplate?e.iconTemplate:e.icon?k(e.icon,"icon icon-sm text-primary"):null}render(){if(!this.fields||this.fields.length===0)return c`<p class="empty-state">No data available.</p>`;const t={"--columns":`${Math.max(1,this.columns||1)}`};return c`
      <div class="field-grid" style=${Dr(t)}>
        ${xt(this.fields,(r,a)=>r.label??`${a}`,r=>{const a=this.getIconTemplate(r);return c`
              <div class="field-item">
                ${a?c`<div class="field-icon">${a}</div>`:""}
    ...
    `],Bt([d({type:Array,attribute:!1})],pt.prototype,"fields",2),Bt([d({type:Number})],pt.prototype,"columns",2),pt=Bt([y("field-list-widget")],pt);var Tr=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,qt=(e,t,r,a)=>{for(var o=a>1?void 0:a?Mr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Tr(t,r,o),o};const Nr=[{label:"Manager",title:"Maria Thompson",icon:"user",highlight:!0},{label:"Location",title:"Dallas Distribution Center, Building C",icon:"map-pin"},{label:"Work phone",title:"+1 (214) 555-0182",icon:"phone"},{label:"Job Title",title:"Forklift Operator",icon:"briefcase"},{label:"Work Schedule",title:"Mon-Fri, 6:00 AM – 2:30 PM",icon:"calendar"},{label:"Department",title:"Warehouse Operations",icon:"building"},{label:"Email",title:"james.davis@nova.com",icon:"envelope",highlight:!0},{label:"Nickname",title:"JD",icon:"tag"}];let dt=class extends b{constructor(){super(),this.fields=[],this.columns=2,this.fields=[...Nr]}getIconFromString(e){const t={user:de,"map-pin":Ye,phone:ir,briefcase:cr,calendar:ar,building:Qe,envelope:Ve,tag:lr,mobile:Ke},r=t[e];return r||(console.warn(`[employee-details-widget] Unknown icon "${e}", defaulting to "user".`),t.user)}render(){const e=this.fields.map(t=>{const r=this.getIconFromString(t.icon);return{...t,iconTemplate:k(r,"icon icon-sm text-primary")}});return c`
      <section role="region">
        <field-list-widget
          .fields=${e}
    ...
    `}};dt.styles=[D,A,O,S,L,z,X,f`
      :host {
        font-size: 16px;
        display: block;
      }
    `],qt([d({attribute:"fields",converter:{fromAttribute:e=>{if(!e)return[];try{return JSON.parse(e)}catch(t){return console.warn("[employee-details-widget] Unable to parse fields attribute, expected JSON array.",t),[]}}}})],dt.prototype,"fields",2),qt([d({type:Number})],dt.prototype,"columns",2),dt=qt([y("employee-details-widget")],dt);var jr=Object.defineProperty,Lr=Object.getOwnPropertyDescriptor,be=(e,t,r,a)=>{for(var o=a>1?void 0:a?Lr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&jr(t,r,o),o};let $t=class extends b{constructor(){super(...arguments),this.fields=[]}render(){var e;return(e=this.fields)!=null&&e.length?c`
    ...
    `}renderInitials(e){const t=this.getInitials(e);return c` <span class="avatar">${t}</span> `}getInitials(e){var r,a;if(e.firstName||e.lastName)return((((r=e.firstName)==null?void 0:r.charAt(0))??"")+(((a=e.lastName)==null?void 0:a.charAt(0))??"")).toUpperCase();const t=e.name.split(" ");return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():t[0][0].toUpperCase()}};$t.styles=[D,A,O,S,z,f`
      :host {
        font-size: 16px;
        display: block;
        color: var(--color-text, #111827);
    ...
    `],be([d({type:Array})],$t.prototype,"fields",2),$t=be([y("field-users-widget")],$t);var Ur=Object.defineProperty,Ir=Object.getOwnPropertyDescriptor,kt=(e,t,r,a)=>{for(var o=a>1?void 0:a?Ir(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Ur(t,r,o),o};let Z=class extends b{constructor(){super(...arguments),this.teamData=null,this.openStates=[],this.sections=[]}updated(e){e.has("teamData")&&(this.transformTeamData(),this.syncOpenStates())}syncOpenStates(){this.openStates=this.sections.map((e,t)=>this.openStates[t]??!0)}transformTeamData(){var r,a,o;if(!this.teamData){this.sections=[];return}if(Array.isArray(this.teamData)){this.sections=this.teamData;return}const e=this.teamData,t=[];e.direct_manager&&t.push({sectionTitle:"Direct manager",users:[e.direct_manager]}),(r=e.other_managers)!=null&&r.length&&t.push({sectionTitle:"Other managers",users:e.other_managers}),(a=e.coworkers)!=null&&a.length&&t.push({sectionTitle:"Coworkers",users:e.coworkers}),(o=e.direct_reports)!=null&&o.length&&t.push({sectionTitle:"Direct reports",users:e.direct_reports}),this.sections=t}getSections(){return this.sections}setTeamData(e){this.teamData=e}toggleSection(e){const t=[...this.openStates];t[e]=!t[e],this.openStates=t}renderSection(e,t){const r=this.openStates[t],a=`team-panel-${t}`,o=`team-toggle-${t}`;return c`
      <div class="section">
        <button
          id=${o}
          type="button"
    ...
    `],kt([d({attribute:!1})],Z.prototype,"teamData",2),kt([x()],Z.prototype,"openStates",2),kt([x()],Z.prototype,"sections",2),Z=kt([y("employee-team-widget")],Z);var Rr=Object.defineProperty,Hr=Object.getOwnPropertyDescriptor,F=(e,t,r,a)=>{for(var o=a>1?void 0:a?Hr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Rr(t,r,o),o};let P=class extends b{constructor(){super(...arguments),this.contacts=[],this.addModalOpen=!1,this.draft={name:"",relationship:"",emergencyContact:!1},this.handleOpenClick=()=>{this.onRequestOpen?this.onRequestOpen():this.addModalOpen=!0},this.handleSubmit=e=>{var r;e.preventDefault();const t={...this.draft};(r=this.onAddContact)==null||r.call(this,t),this.dispatchEvent(new CustomEvent("add-contact",{detail:t,bubbles:!0,composed:!0})),this.resetDraft(),this.addModalOpen=!1},this.handleClose=()=>{var e;this.resetDraft(),this.addModalOpen=!1,(e=this.onRequestClose)==null||e.call(this)}}resetDraft(){this.draft={name:"",relationship:"",emergencyContact:!1}}render(){var t;const e=((t=this.contacts)==null?void 0:t.length)>0;return c`
      ...
      ${this.addModalOpen?c`
          ...
          `:null}
    `}};P.styles=[D,A,O,S,L,z,ur,br,fr,f`
      :host {
        font-size: 16px;
        display: block;
        color: var(--color-text, #111827);
    ...
    `],F([d({attribute:!1})],P.prototype,"contacts",2),F([d({type:Boolean})],P.prototype,"addModalOpen",2),F([d({attribute:!1})],P.prototype,"onAddContact",2),F([d({attribute:!1})],P.prototype,"onRequestOpen",2),F([d({attribute:!1})],P.prototype,"onRequestClose",2),F([x()],P.prototype,"draft",2),P=F([y("employee-contacts-widget")],P);var Br=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,Ft=(e,t,r,a)=>{for(var o=a>1?void 0:a?qr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Br(t,r,o),o};let _t=class extends b{constructor(){super(...arguments),this.open=!1,this.draft={name:"",relationship:"",emergencyContact:!1},this.submit=e=>{e.preventDefault(),this.dispatchEvent(new CustomEvent("submit-contact",{detail:{...this.draft},bubbles:!0,composed:!0})),this.close()}}createRenderRoot(){return this}willUpdate(e){e.has("open")&&this.open&&(this.draft={name:"",relationship:"",emergencyContact:!1})}close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}render(){return this.open?c`
      <div
    ...
    `],ht([d({type:Object,attribute:!1})],W.prototype,"profileData",2),ht([d({type:Array,attribute:!1})],W.prototype,"showSections",2),ht([d({type:Object,attribute:!1})],W.prototype,"sectionTitles",2),ht([x()],W.prototype,"addContactOpen",2),W=ht([y("profile-details")],W);var Yr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,me=(e,t,r,a)=>{for(var o=a>1?void 0:a?Vr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Yr(t,r,o),o};let Wt=class extends b{constructor(){super(...arguments),this.profileOpen=!1,this.onWindowClick=e=>{var r;(((r=e.composedPath)==null?void 0:r.call(e))??(()=>{const a=[];let o=e.target;for(;o;)a.push(o),o=o.parentNode;return a})()).includes(this)||(this.profileOpen=!1)},this.onKeyDown=e=>{e.key==="Escape"&&(this.profileOpen=!1,this.focusProfileButton())},this.onMenuKeyDown=e=>{if(!this.profileOpen)return;const t=this.getMenuItems();if(!t.length)return;const r=t.indexOf(document.activeElement),a=o=>{const i=t[o];i&&i.focus()};switch(e.key){case"ArrowDown":e.preventDefault(),a((r+1)%t.length);break;case"ArrowUp":e.preventDefault(),a((r-1+t.length)%t.length);break;case"Home":e.preventDefault(),a(0);break;case"End":e.preventDefault(),a(t.length-1);break;case"Escape":e.preventDefault(),this.profileOpen=!1,this.focusProfileButton();break}}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),window.addEventListener("click",this.onWindowClick),window.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){window.removeEventListener("click",this.onWindowClick),window.removeEventListener("keydown",this.onKeyDown),super.disconnectedCallback()}focusProfileButton(){var t;const e=(t=this.renderRoot)==null?void 0:t.querySelector("#profile-button");e==null||e.focus()}focusFirstMenuItem(){const[e]=this.getMenuItems();e==null||e.focus()}getMenuItems(){var t;const e=(t=this.renderRoot)==null?void 0:t.querySelector("#profile-menu");return e?Array.from(e.querySelectorAll('[role="menuitem"]')):[]}toggleProfile(e){e.stopPropagation();const t=!this.profileOpen;this.profileOpen=t,t?this.updateComplete.then(()=>this.focusFirstMenuItem()):this.focusProfileButton()}iconButton(e,t){return c`
      <button
    ...
    `}render(){const e=Nt({"absolute right-0 mt-2 w-48 rounded-lg shadow-lg z-50 bg-white border":!0,"ring-2 ring-indigo-300":this.profileOpen,hidden:!this.profileOpen});return c`
      ...
      >
        ...
        <div class="flex items-center gap-4">
          ...
          <!-- Settings -->
          ${this.iconButton("Settings",k(pe,"w-5 h-5"))}
    ...
    `}};me([x()],Wt.prototype,"profileOpen",2),Wt=me([y("top-bar")],Wt);var Jr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor,Yt=(e,t,r,a)=>{for(var o=a>1?void 0:a?Kr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Jr(t,r,o),o};let Ct=class extends b{constructor(){super(...arguments),this.open=!1,this.employee=null}createRenderRoot(){return this}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_onOpenOrgChart(){this.dispatchEvent(new CustomEvent("open-org-chart",{detail:this.employee,bubbles:!0,composed:!0}))}render(){if(!this.open||!this.employee)return null;const e=this.employee;return c`
      <div
    ...
    `}};Yt([d({type:Boolean})],Ct.prototype,"open",2),Yt([d({type:Object})],Ct.prototype,"employee",2),Ct=Yt([y("org-chart-modal")],Ct);var Xr=Object.defineProperty,Gr=Object.getOwnPropertyDescriptor,At=(e,t,r,a)=>{for(var o=a>1?void 0:a?Gr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Xr(t,r,o),o};$.AppLayout=class extends b{constructor(){super(...arguments),this.activeTab="overview",this.showOrgChartModal=!1,this.selectedEmployee=null}createRenderRoot(){return this}onSectionChange(t){this.activeTab=t.detail.value}onOrgChartClick(t){const{employeeId:r,employee:a}=t.detail;this.selectedEmployee={id:r,...a},this.showOrgChartModal=!0}closeModal(){this.showOrgChartModal=!1,this.selectedEmployee=null}handleOpenOrgChart(t){const r=t.detail;alert(`Opening full organization chart for ${r.fullName}...
