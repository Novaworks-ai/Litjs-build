 ...
 */let Lt=class extends jt{};Lt.directiveName="unsafeSVG",Lt.resultType=2;const pr=mt(Lt),k=(e,t="")=>{if(!e||!e.icon)return c``;const r=e.icon[0],a=e.icon[1],o=e.icon[4],i=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${r} ${a}" fill="currentColor" aria-hidden="true"><path d="${o}"/></svg>`;return c`<span class="${t} inline-block">${pr(i)}</span>`};var dr=Object.defineProperty,hr=Object.getOwnPropertyDescriptor,wt=(e,t,r,a)=>{for(var o=a>1?void 0:a?hr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&dr(t,r,o),o};let it=class extends f{constructor(){super(...arguments),this.employeeId="",this.employee={fullName:"John Doe",title:"Senior Frontend Engineer",location:"New York, USA",avatarUrl:"https://i.pravatar.cc/150?img=12"}}createRenderRoot(){return this}updated(e){e.has("employeeId")&&this._loadEmployee(this.employeeId)}async _loadEmployee(e){}_handleOrgChartClick(){this.onOrgChartClick&&this.onOrgChartClick(this.employeeId,this.employee),this.dispatchEvent(new CustomEvent("org-chart-click",{detail:{employeeId:this.employeeId,employee:this.employee},bubbles:!0}))}_onTabChange(e){this.dispatchEvent(new CustomEvent("section-change",{detail:e.detail,bubbles:!0,composed:!0}))}render(){const e=this.employee;return c`
    ...
    `}};wt([d({type:String})],it.prototype,"employeeId",2),wt([x()],it.prototype,"employee",2),wt([d({type:Function})],it.prototype,"onOrgChartClick",2),it=wt([y("profile-header")],it);const A=b`
  :host {
    font-size: 16px;
...
`;var mr=Object.defineProperty,vr=Object.getOwnPropertyDescriptor,yt=(e,t,r,a)=>{for(var o=a>1?void 0:a?vr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&mr(t,r,o),o};let he=0,G=class extends f{constructor(){super(...arguments),this.title="Title",this.collapsed=!1,this.contentId=`accordion-content-${++he}`,this.buttonId=`accordion-button-${he}`}toggle(){this.collapsed=!this.collapsed}render(){return c`
      <div class="accordion">
        <button
          id=${this.buttonId}
          class="header"
    ...
    `],yt([d({type:String})],G.prototype,"title",2),yt([d({type:String})],G.prototype,"icon",2),yt([x()],G.prototype,"collapsed",2),G=yt([y("accordion-widget")],G);var wr=Object.defineProperty,yr=Object.getOwnPropertyDescriptor,Ut=(e,t,r,a)=>{for(var o=a>1?void 0:a?yr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&wr(t,r,o),o};let st=class extends f{constructor(){super(...arguments),this.title="",this.icon=""}render(){return c`
    ...
    `}};st.styles=[P,A,O,S,L,D,X,b`
      :host {
        font-size: 16px;
        display: block;
      }

    `],Ut([d({type:String})],st.prototype,"title",2),Ut([d({type:String})],st.prototype,"icon",2),st=Ut([y("card-widget")],st);var xr=Object.defineProperty,$r=Object.getOwnPropertyDescriptor,It=(e,t,r,a)=>{for(var o=a>1?void 0:a?$r(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&xr(t,r,o),o};let nt=class extends f{constructor(){super(...arguments),this.label="About"}render(){const e=!!(this.text&&this.text.trim());return c`
      <div role="region" aria-label=${this.label}>
        <h2 class="sr-only">${this.label}</h2>
        ${e?c`<p class="text">${this.text}</p>`:c`<slot></slot>`}
      </div>
    `}};nt.styles=[P,A,O,S,L,D,X,b`
      :host {
        font-size: 16px;
        display: block;
      }
 ...
 */const ge=(e,t,r)=>{const a=new Map;for(let o=t;o<=r;o++)a.set(e[o],o);return a},xt=mt(class extends vt{constructor(e){if(super(e),e.type!==ft.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,r){let a;r===void 0?r=t:t!==void 0&&(a=t);const o=[],i=[];let s=0;for(const l of e)o[s]=a?a(l,s):s,i[s]=r(l,s),s++;return{values:i,keys:o}}render(e,t,r){return this.dt(e,t,r).values}update(e,[t,r,a]){const o=Ar(e),{values:i,keys:s}=this.dt(t,r,a);if(!Array.isArray(o))return this.ut=s,i;const l=this.ut??(this.ut=[]),n=[];let h,m,p=0,g=o.length-1,u=0,w=i.length-1;for(;p<=g&&u<=w;)if(o[p]===null)p++;else if(o[g]===null)g--;else if(l[p]===s[u])n[u]=q(o[p],i[u]),p++,u++;else if(l[g]===s[w])n[w]=q(o[g],i[w]),g--,w--;else if(l[p]===s[w])n[w]=q(o[p],i[w]),lt(e,n[w+1],o[p]),p++,w--;else if(l[g]===s[u])n[u]=q(o[g],i[u]),lt(e,o[p],o[g]),g--,u++;else if(h===void 0&&(h=ge(s,u,w),m=ge(l,p,g)),h.has(l[p]))if(h.has(l[g])){const E=m.get(s[u]),Vt=E!==void 0?o[E]:null;if(Vt===null){const we=lt(e,o[p]);q(we,i[u]),n[u]=we}else n[u]=q(Vt,i[u]),lt(e,o[p],Vt),o[E]=null;u++}else Rt(o[g]),g--;else Rt(o[p]),p++;for(;u<=w;){const E=lt(e,n[w+1]);q(E,i[u]),n[u++]=E}for(;p<=g;){const E=o[p++];E!==null&&Rt(E)}return this.ut=s,Cr(e,n),_}});var Sr=Object.defineProperty,Or=Object.getOwnPropertyDescriptor,Ht=(e,t,r,a)=>{for(var o=a>1?void 0:a?Or(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Sr(t,r,o),o};let ct=class extends f{constructor(){super(...arguments),this.skillsData=null,this.sections=[]}updated(e){e.has("skillsData")&&this.transformSkillsData()}transformSkillsData(){var r,a;if(!this.skillsData){this.sections=[];return}if(Array.isArray(this.skillsData)){this.sections=this.skillsData;return}const e=this.skillsData,t=[];(r=e.required_skills)!=null&&r.length&&t.push({sectionTitle:"Required Skills",skills:e.required_skills}),(a=e.additional_skills)!=null&&a.length&&t.push({sectionTitle:"Additional Skills",skills:e.additional_skills}),this.sections=t}getSections(){return this.sections}setSkillsData(e){this.skillsData=e}renderSection(e,t){return c`
    ...
    `:c`<p class="empty-state" role="status">No skills available.</p>`}};ct.styles=[P,A,O,S,L,D,gr,b`
      :host {
        font-size: 16px;
        display: block;
        color: var(--color-text, #111827);
 ...
 */const be="important",Dr=" !"+be,Pr=mt(class extends vt{constructor(e){var t;if(super(e),e.type!==ft.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,r)=>{const a=e[r];return a==null?t:t+`${r=r.includes("-")?r:r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const a of this.ft)t[a]==null&&(this.ft.delete(a),a.includes("-")?r.removeProperty(a):r[a]=null);for(const a in t){const o=t[a];if(o!=null){this.ft.add(a);const i=typeof o=="string"&&o.endsWith(Dr);a.includes("-")||i?r.setProperty(a,i?o.slice(0,-11):o,i?be:""):r[a]=o}}return _}});var zr=Object.defineProperty,Er=Object.getOwnPropertyDescriptor,Bt=(e,t,r,a)=>{for(var o=a>1?void 0:a?Er(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&zr(t,r,o),o};let pt=class extends f{constructor(){super(...arguments),this.fields=[],this.columns=2}getIconTemplate(e){return e.iconTemplate?e.iconTemplate:e.icon?k(e.icon,"icon icon-sm text-primary"):null}render(){if(!this.fields||this.fields.length===0)return c`<p class="empty-state">No data available.</p>`;const t={"--columns":`${Math.max(1,this.columns||1)}`};return c`
    ...
    `}};dt.styles=[P,A,O,S,L,D,X,b`
      :host {
        font-size: 16px;
        display: block;
      }
    `],qt([d({attribute:"fields",converter:{fromAttribute:e=>{if(!e)return[];try{return JSON.parse(e)}catch(t){return console.warn("[employee-details-widget] Unable to parse fields attribute, expected JSON array.",t),[]}}}})],dt.prototype,"fields",2),qt([d({type:Number})],dt.prototype,"columns",2),dt=qt([y("employee-details-widget")],dt);var jr=Object.defineProperty,Lr=Object.getOwnPropertyDescriptor,fe=(e,t,r,a)=>{for(var o=a>1?void 0:a?Lr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&jr(t,r,o),o};let $t=class extends f{constructor(){super(...arguments),this.fields=[]}render(){var e;return(e=this.fields)!=null&&e.length?c`
    ...
    `}renderInitials(e){const t=this.getInitials(e);return c` <span class="avatar">${t}</span> `}getInitials(e){var r,a;if(e.firstName||e.lastName)return((((r=e.firstName)==null?void 0:r.charAt(0))??"")+(((a=e.lastName)==null?void 0:a.charAt(0))??"")).toUpperCase();const t=e.name.split(" ");return t.length>=2?(t[0][0]+t[1][0]).toUpperCase():t[0][0].toUpperCase()}};$t.styles=[P,A,O,S,D,b`
      :host {
        font-size: 16px;
        display: block;
        color: var(--color-text, #111827);
    ...
    `],kt([d({attribute:!1})],Z.prototype,"teamData",2),kt([x()],Z.prototype,"openStates",2),kt([x()],Z.prototype,"sections",2),Z=kt([y("employee-team-widget")],Z);var Rr=Object.defineProperty,Hr=Object.getOwnPropertyDescriptor,F=(e,t,r,a)=>{for(var o=a>1?void 0:a?Hr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Rr(t,r,o),o};let z=class extends f{constructor(){super(...arguments),this.contacts=[],this.addModalOpen=!1,this.draft={name:"",relationship:"",emergencyContact:!1},this.handleOpenClick=()=>{this.onRequestOpen?this.onRequestOpen():this.addModalOpen=!0},this.handleSubmit=e=>{var r;e.preventDefault();const t={...this.draft};(r=this.onAddContact)==null||r.call(this,t),this.dispatchEvent(new CustomEvent("add-contact",{detail:t,bubbles:!0,composed:!0})),this.resetDraft(),this.addModalOpen=!1},this.handleClose=()=>{var e;this.resetDraft(),this.addModalOpen=!1,(e=this.onRequestClose)==null||e.call(this)}}resetDraft(){this.draft={name:"",relationship:"",emergencyContact:!1}}render(){var t;const e=((t=this.contacts)==null?void 0:t.length)>0;return c`
      ...
      ${this.addModalOpen?c`
          ...
          `:null}
    `}};z.styles=[P,A,O,S,L,D,ur,fr,br,b`
      :host {
        font-size: 16px;
        display: block;
        color: var(--color-text, #111827);
    ...
    `],F([d({attribute:!1})],z.prototype,"contacts",2),F([d({type:Boolean})],z.prototype,"addModalOpen",2),F([d({attribute:!1})],z.prototype,"onAddContact",2),F([d({attribute:!1})],z.prototype,"onRequestOpen",2),F([d({attribute:!1})],z.prototype,"onRequestClose",2),F([x()],z.prototype,"draft",2),z=F([y("employee-contacts-widget")],z);var Br=Object.defineProperty,qr=Object.getOwnPropertyDescriptor,Ft=(e,t,r,a)=>{for(var o=a>1?void 0:a?qr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Br(t,r,o),o};let _t=class extends f{constructor(){super(...arguments),this.open=!1,this.draft={name:"",relationship:"",emergencyContact:!1},this.submit=e=>{e.preventDefault(),this.dispatchEvent(new CustomEvent("submit-contact",{detail:{...this.draft},bubbles:!0,composed:!0})),this.close()}}createRenderRoot(){return this}willUpdate(e){e.has("open")&&this.open&&(this.draft={name:"",relationship:"",emergencyContact:!1})}close(){this.dispatchEvent(new CustomEvent("close-modal",{bubbles:!0,composed:!0}))}render(){return this.open?c`
      <div
    ...
    `}};me([x()],Wt.prototype,"profileOpen",2),Wt=me([y("top-bar")],Wt);var Jr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor,Yt=(e,t,r,a)=>{for(var o=a>1?void 0:a?Kr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Jr(t,r,o),o};let Ct=class extends f{constructor(){super(...arguments),this.open=!1,this.employee=null}createRenderRoot(){return this}_onClose(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_onOpenOrgChart(){this.dispatchEvent(new CustomEvent("open-org-chart",{detail:this.employee,bubbles:!0,composed:!0}))}render(){if(!this.open||!this.employee)return null;const e=this.employee;return c`
      <div
    ...
    `}};Yt([d({type:Boolean})],Ct.prototype,"open",2),Yt([d({type:Object})],Ct.prototype,"employee",2),Ct=Yt([y("org-chart-modal")],Ct);var Xr=Object.defineProperty,Gr=Object.getOwnPropertyDescriptor,At=(e,t,r,a)=>{for(var o=a>1?void 0:a?Gr(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(a?s(t,r,o):s(o))||o);return a&&o&&Xr(t,r,o),o};$.AppLayout=class extends f{constructor(){super(...arguments),this.activeTab="overview",this.showOrgChartModal=!1,this.selectedEmployee=null}createRenderRoot(){return this}onSectionChange(t){this.activeTab=t.detail.value}onOrgChartClick(t){const{employeeId:r,employee:a}=t.detail;this.selectedEmployee={id:r,...a},this.showOrgChartModal=!0}closeModal(){this.showOrgChartModal=!1,this.selectedEmployee=null}handleOpenOrgChart(t){const r=t.detail;alert(`Opening full organization chart for ${r.fullName}...
