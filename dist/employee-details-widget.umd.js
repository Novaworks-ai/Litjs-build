...
`;var ht=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,ie=(s,e,t,i)=>{for(var r=i>1?void 0:i?ft(e,t):e,o=s.length-1,n;o>=0;o--)(n=s[o])&&(r=(i?n(e,t,r):n(r))||r);return i&&r&&ht(e,t,r),r};let D=class extends M{constructor(){super(...arguments),this.fields=[],this.columns=2}getIconTemplate(s){return s.iconTemplate?s.iconTemplate:s.icon?Ae(s.icon,"icon icon-sm text-primary"):null}render(){if(!this.fields||this.fields.length===0)return A`<p class="empty-state">No data available.</p>`;const e={"--columns":`${Math.max(1,this.columns||1)}`};return A`
    ...
    `],re([B({attribute:"fields",converter:{fromAttribute:s=>{if(!s)return[];try{return JSON.parse(s)}catch(e){return console.warn("[employee-details-widget] Unable to parse fields attribute, expected JSON array.",e),[]}}}})],v.EmployeeDetailsWidget.prototype,"fields",2),re([B({type:Number})],v.EmployeeDetailsWidget.prototype,"columns",2),v.EmployeeDetailsWidget=re([ye("employee-details-widget")],v.EmployeeDetailsWidget),Object.defineProperty(v,Symbol.toStringTag,{value:"Module"})}));
