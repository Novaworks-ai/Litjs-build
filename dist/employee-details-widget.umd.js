 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class oe extends re{}oe.directiveName="unsafeSVG",oe.resultType=2;const ht=te(oe),Ce=(r,e="")=>{if(!r||!r.icon)return E``;const t=r.icon[0],i=r.icon[1],s=r.icon[4],n=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${t} ${i}" fill="currentColor" aria-hidden="true"><path d="${s}"/></svg>`;return E`<span class="${e} inline-block">${ht(n)}</span>`},Pe=_`
  :host {
